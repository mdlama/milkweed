...
sbetas[4,] = c('Clonal Reproduction', 0, 0, scale.c$coefficients[2], 0)  ## hardcoded to only show cardenolides, since that is the only cofficient in our model (sans intercept)
...
##Saving
```{r}
#ggsave() #figure out good sizing and save as pdf
```
