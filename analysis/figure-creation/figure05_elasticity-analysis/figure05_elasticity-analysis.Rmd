...
```{r}
#saved panels separately, to scale them so that the axes are equal (i.e. panel b is longer), then adding full legend... final dimension 110 mm wide x 150 mm tall
```
