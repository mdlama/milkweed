...
# shapes = c(15, 0, 6, 17, 19)
shapes = c(15, 22, 25, 17, 19)
...
```{r}
#ggsave('figure05a.pdf', width = 110, height = 53.9, units = 'mm', device = 'pdf')
```
...
```{r}
#ggsave('figure05b.pdf', width = 110, height = 93.1, units = 'mm', device = 'pdf')
```
...
g1 <- ggplotGrob(dist.plot)
# g1 <- gtable::gtable_add_rows(g1, unit(0, "mm"))
# g1 <- gtable::gtable_add_rows(g1, unit(0, "mm"))
g2 <- ggplotGrob(vr.plot)
g <- rbind(g1, g2, size="first")
p <- gridExtra::grid.arrange(g1, g2, nrow=2)
ggsave("figure05_draft.png", width=7.5, height=10, device = "png", p)
```
