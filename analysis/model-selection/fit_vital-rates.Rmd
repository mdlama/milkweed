...
flower.plots = grid.arrange(f1, f2, f3, f4, f5, f6)
```
...
surv.plots = grid.arrange(s1, s2, s3, s4, s5, s6)
```
...
growth.plots = grid.arrange(g1, g2, g3, g4, g5, g6)
```
...
pods.plots = grid.arrange(p1, p2, p3, p4, p5, p6)
```
