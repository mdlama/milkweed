...
growth.reg.mdl4=lmer(h_apical.next~h_apical*herb_avg + (1|site/transect)+(h_apical+herb_avg|year),data=metadata_sc, REML=T)
...
growth.reg.mdl5=lmer(h_apical.next~h_apical*herb_avg + (1|site/transect)+(h_apical|year),data=metadata_sc, REML=T)
...
growth.reg.mdl6=lmer(h_apical.next~h_apical*herb_avg + (1|site/transect)+(herb_avg|year),data=metadata_sc, REML=T)
...
```{r}
growth.reg.mdl1a=lmer(h_apical.next ~ h_apical*herb_avg + (h_apical+herb_avg|site/transect)+(h_apical*herb_avg|year), data=metadata_sc, REML=F)
#do single-term deletions to see which term needs to be dropped first
drop1(growth.reg.mdl2a, scope=c("h_apical", "herb_avg", "h_apical:herb_avg"))

# Looks like interaction goes first based on the drop1() results
growth.reg.mdl1b=lmer(h_apical.next ~ h_apical+herb_avg + (h_apical+herb_avg|site/transect)+(h_apical*herb_avg|year), data=metadata_sc, REML=F) #all 3 remaining terms
...
growth.reg.final = lmer(h_apical.next ~ h_apical + (h_apical+herb_avg|site/transect)+(h_apical+herb_avg|year), data=metadata_sc, REML=T)
